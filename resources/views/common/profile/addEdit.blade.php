		...
		<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
			<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
				...
				<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
					...
					<li class="breadcrumb-item">{{ $getCurrentTranslation['my_profile'] ?? 'my_profile' }}</li>
				</ul>
			</div>
				...
				<div class="col-md-12 m-auto">
					<div class="card rounded border mt-5 bg-white append-item-container">
						<div class="card-header">
							<h3 class="card-title">{{ $getCurrentTranslation['profile_info'] ?? 'profile_info' }}</h3>
					...
					<div class="card rounded border mt-5 bg-white append-item-container">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-6">
									<label class="form-label">{{ $getCurrentTranslation['old_password_label'] ?? 'old_password_label' }}:</label>
									<div class="form-item mb-5 position-relative">
										<input type="password" name="current_password" placeholder="{{ $getCurrentTranslation['old_password_placeholder'] ?? 'old_password_placeholder' }}" class="form-control bg-transparent password" required autocomplete="new-password" value="">
								...
								<div class="col-md-6">
									...
									<div class="form-item mb-5 position-relative">
										<input type="password" name="new_password" placeholder="{{ $getCurrentTranslation['password_placeholder'] ?? 'password_placeholder' }}" class="form-control bg-transparent password" required autocomplete="new-password" value="">
										<span class="toggle-password" minlength="8" data-show="f06e" data-hide="f070"></span>
									</div>
									@error('new_password')
										<span class="text-danger text-sm text-red text-bold">{{ $message }}</span>
								...
								<div class="col-md-6">
									...
									<div class="form-item mb-5 position-relative">
										<input type="password" name="new_password_confirmation" placeholder="{{ $getCurrentTranslation['confirm_password_label'] ?? 'confirm_password_label' }}" class="form-control bg-transparent password" minlength="8" required>
