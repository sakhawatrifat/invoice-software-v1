									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-item mb-5">
												...
												<select class="form-select dynamic-option select2-with-images" data-control="select2" data-class="flag" data-placeholder="{{ $getCurrentTranslation['select_an_option'] ?? 'select_an_option' }}" name="customer_country_id" >
													<option value="0">----</option>
													@foreach($options as $option)
										...
										<div class="col-md-3">
											<div class="form-item mb-5">
												...
												<select class="form-select dynamic-option" data-control="select2" data-placeholder="{{ $getCurrentTranslation['gender_placeholder'] ?? 'gender_placeholder' }}" name="gender">
													<option value="0">----</option>
