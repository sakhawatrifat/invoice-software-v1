...
<script>
$(function() {
	var reminderInput = document.getElementById('sticky_note_reminder_datetime');
	var deadlineInput = document.getElementById('sticky_note_deadline');
	if (!reminderInput || !deadlineInput) return;
	...
	// Set reminder maxDate from existing deadline on load (create/edit with existing values)
