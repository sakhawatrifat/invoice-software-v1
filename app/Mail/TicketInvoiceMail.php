...
class TicketInvoiceMail extends Mailable
{
    ...
    {
        $reservationNumber = $this->mailPayload['mailData']['reservation_number'] ?? '';
        $subject = 'Air Ticket Confirmation – Booking ID: ' . $reservationNumber;
    ...
    public function content(): Content
    {
        return new Content(
            ...
            with: [
                'passengers' => $this->mailPayload['passengers'] ?? [],
