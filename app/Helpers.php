...
if (!function_exists('passengerCountsLineHtml')) {
    /**
     * Return one-line HTML for Adult, Child, Infant (SVG icon + number).
    ...
    function passengerCountsLineHtml($passengers)
    {
        ...
        $item = function ($svgHtml, $count) {
            return '<span class="passenger-count-item d-inline-flex align-items-center">' . $svgHtml . ' ' . (int) $count . '</span>';
        };
        if (!$passengers) {
            $passengers = collect();
        }
        ...
        $adult = max(0, $passengers->count() - $child - $infant);

        $adultSvg = '<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 92.02 213.551" viewBox="0 0 92.02 213.551" id="adult" width="16" height="14"><path d="M46.01,115.33c-11.447-0.009-21.212-3.167-27.479-5.866l0.012,0.671c0,2.248,0.638,7.749,2.058,12.018
		c0.941,38.642,1.991,80.51,1.991,80.51c0,6.016,4.877,10.889,10.889,10.889s10.889-4.873,10.889-10.889v-74.881h3.285v74.881
		c0,6.016,4.877,10.889,10.889,10.889c6.014,0,10.891-4.873,10.891-10.889c0,0,1.051-41.869,1.991-80.513
		c1.419-4.268,2.056-9.768,2.056-12.015l0.012-0.671C67.224,112.163,57.459,115.321,46.01,115.33z"></path><path d="M71.785,41.002c-3.171-1.598-5.932-1.905-7.473-1.9c-0.554,0-0.966,0.037-1.214,0.067c-0.854,0.108-1.645,0.38-2.352,0.775
		c-4.271,5.488-9.788,9.395-14.736,9.395c-4.946,0-10.461-3.904-14.731-9.39c-0.71-0.397-1.504-0.672-2.361-0.779v-0.002
		c-0.247-0.03-0.656-0.067-1.208-0.067c-1.542-0.007-4.305,0.301-7.477,1.901C15.43,43.389,10.151,48.63,6.396,58.184
		C2.6,67.769,0.011,81.761,0,102.986c0,5.487,0.178,11.459,0.561,17.965c0.202,3.453,3.068,6.118,6.483,6.118
		c0.128,0,0.257-0.004,0.386-0.011c3.584-0.21,6.318-3.287,6.107-6.87c-0.279-4.781-0.444-9.234-0.507-13.389
		c-0.018-1.182-0.025-2.335-0.026-3.468c0-0.113-0.003-0.233-0.003-0.346c-0.022-18.504,2.145-30.51,4.757-38.065l0.715,41.237
		c1.111,0.504,2.359,1.037,3.742,1.571c5.97,2.305,14.321,4.604,23.795,4.601c11.671,0.006,21.632-3.491,27.539-6.171l0.716-41.231
		c2.614,7.552,4.77,19.574,4.754,38.065c0,0.11-0.003,0.229-0.003,0.341c-0.001,1.133-0.01,2.286-0.027,3.468
		c-0.063,4.155-0.225,8.609-0.502,13.391c-0.209,3.583,2.526,6.658,6.111,6.867c0.127,0.007,0.255,0.011,0.381,0.011
		c3.417,0.001,6.284-2.666,6.485-6.121c0.377-6.504,0.554-12.468,0.556-17.956c-0.034-28.278-4.571-43.804-10.584-52.978
		C78.43,45.458,74.961,42.588,71.785,41.002z"></path><path d="M46.011,47.338c8.611,0,20-14.488,20-26.178c0-11.686-8.955-21.16-20-21.16s-20,9.475-20,21.16
		C26.011,32.85,37.399,47.338,46.011,47.338z"></path></svg>';
        $childSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" id="child"><path fill="#444" d="M10 5a2 2 0 1 1-3.999.001A2 2 0 0 1 10 5z"></path><path fill="#444" d="m12.79 10.32-2.6-2.63A2.311 2.311 0 0 0 8.54 7H7.469c-.648 0-1.235.264-1.659.69l-2.6 2.63a.73.73 0 1 0 .998 1.003L6 9.53V16h1.5v-4h1v4H10V9.53l1.75 1.8a.73.73 0 1 0 1.041-1.009z"></path></svg>';
        $infantSvg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="infant" width="16" height="16"><path d="M41.49707,40.65527a3.26009,3.26009,0,0,0-1.6875.61524,3.50892,3.50892,0,0,0-4.58884.55573c-2.2451,2.90857.25429,5.42346,3.66,7.95507a1.658,1.658,0,0,0,1.85952-.002A14.27229,14.27229,0,0,0,44.66309,45.958,3.44024,3.44024,0,0,0,41.49707,40.65527Zm1.66016,3.86621a10.03349,10.03349,0,0,1-3.34758,3.47175,12.05773,12.05773,0,0,1-3.17977-3.1319,1.42746,1.42746,0,0,1,2.31058-1.66988,1.0182,1.0182,0,0,0,1.72946.01555,1.29913,1.29913,0,0,1,.97168-.55759A1.4252,1.4252,0,0,1,43.15723,44.52148Z"></path><path d="M49.99023,21.95441a17.5046,17.5046,0,0,0-2.84375-9.8714.99975.99975,0,1,0-1.67382,1.09375,15.4577,15.4577,0,0,1,2.51757,8.4834c-.00445,2.7394-.12944,5.01271-3.2313,8.47077A12.54744,12.54744,0,0,1,41.06836,32.649v-.59821a3.88046,3.88046,0,0,0-2.24463-3.51092,9.613,9.613,0,0,0,1.79541-2.72834,3.8498,3.8498,0,0,0-.00011-7.623,9.65629,9.65629,0,0,0-17.75233,0,3.84431,3.84431,0,0,0,0,7.623,9.61917,9.61917,0,0,0,1.78815,2.72028,3.89867,3.89867,0,0,0-2.23639,3.519c-.00914-.007.0236,1.3653-.01461,1.32032-4.09843-1.11732-6.11741-6.73145-6.41362-7.62159V21.66016c-.01372-13.946,17.02045-20.7419,27.02549-11.412a.99981.99981,0,0,0,1.369-1.45718A17.54846,17.54846,0,0,0,32.33008,4,17.7145,17.7145,0,0,0,13.99026,21.66019l0,15.7402a1.0001,1.0001,0,0,0,2,0V30.40063a10.58432,10.58432,0,0,0,5.8877,4.90015c3.458,1.03412,5.102,2.2252,7.08926,5.52788a49.85,49.85,0,0,0-8.913,11.99861,15.58,15.58,0,0,1-4.064-10.48743,1.06959,1.06959,0,0,0-1-1.30956.99972.99972,0,0,0-1,1A17.68958,17.68958,0,0,0,31.64991,60a17.7147,17.7147,0,0,0,18.3403-17.66018l0-19.22085A8.84316,8.84316,0,0,0,49.99023,21.95441ZM23.56348,23.84375a1.84779,1.84779,0,1,1-.19672-3.68752,1.05073,1.05073,0,0,0,1.141-.67188,7.67492,7.67492,0,0,1,3.8133-4.34012,3.49408,3.49408,0,0,0,3.4167,4.15848c1.20082.0563,3.67586-1.1149,2.50253-2.52639a1.00116,1.00116,0,0,0-1.41319.05181,1.4852,1.4852,0,1,1-1.084-2.49512,7.67035,7.67035,0,0,1,7.23535,5.15137.99942.99942,0,0,0,.94433.67187,1.84778,1.84778,0,1,1,.19623,3.68752,1.05031,1.05031,0,0,0-1.14056.67187,7.67867,7.67867,0,0,1-14.4707-.00018A.99952.99952,0,0,0,23.56348,23.84375Zm2.8999,11.294a10.4579,10.4579,0,0,0-2.04492-1.08863V32.05078A2.54071,2.54071,0,0,1,26.196,29.891a9.66429,9.66429,0,0,0,10.8155.20309,2.03985,2.03985,0,0,1,2.05678,1.95677l0,1.51739a37.95838,37.95838,0,0,0-8.5882,5.845A13.65644,13.65644,0,0,0,26.46338,35.1377Zm21.52685,7.20214A15.67824,15.67824,0,0,1,32.33008,58a15.75728,15.75728,0,0,1-10.79-3.72111c6.858-13.0021,16.01745-17.96071,19.67571-19.49178a14.02356,14.02356,0,0,0,6.77441-5.5425Z"></path><path d="M28.51294 22.79291a1.02031 1.02031 0 000-2.04041A1.02031 1.02031 0 0028.51294 22.79291zM34.963 22.79291a1.02031 1.02031 0 000-2.04041A1.02031 1.02031 0 0034.963 22.79291z"></path></svg>';

        $parts = [];
        if ($adult > 0) {
            $parts[] = $item($adultSvg, $adult);
        }
        if ($child > 0) {
            $parts[] = $item($childSvg, $child);
        }
        if ($infant > 0) {
            $parts[] = $item($infantSvg, $infant);
        }
        if (empty($parts)) {
            return '';
        }
